...
namespace FIMSpace.FProceduralAnimation
{
    public partial class RagdollHandler
    {
        ...
        [Tooltip("(Experimental) Disabling all ragdoll dummy components on RagdollAnimator disable, but triggering extra calculations on activting ragdoll again for two fixed update frames.\n\n! It is not working properly when Reconstruction Mode is on.")]
        public bool HardDisable = false;
    }
}