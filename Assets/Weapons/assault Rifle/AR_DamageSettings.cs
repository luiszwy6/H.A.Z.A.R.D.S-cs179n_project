...
public class AR_DamageSetting : MonoBehaviour
{
    [Header("Damage")]
    [SerializeField] private float Base_dmg = 12f;
    ...
    public void ApplyToProjectile(BulletProjectile projectile)
    {
        ...
        {
            Debug.Log(
                $"[AR_DamageSetting] Applied damage payload. Base_dmg={BaseDamage}, ArmoPierLevel={ArmorPierceLevel}, Knockback={Knockback}, PenetrationLevel={PenetrationCount}, Decay={PenetrationDamageDecayPercent}%, PartOverrides={(partOverrides != null ? partOverrides.Length : 0)}",
                this
            );
        }
    }
