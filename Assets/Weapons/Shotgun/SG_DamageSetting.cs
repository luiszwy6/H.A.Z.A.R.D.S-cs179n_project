...
public class SG_DamageSetting : MonoBehaviour
{
    [Header("Damage")]
    [SerializeField] private float Base_dmg = 6f;
    ...
    public void ApplyToProjectile(BulletProjectile projectile)
    {
        ...
        {
            Debug.Log(
                $"[SG_DamageSetting] Applied damage payload. Base_dmg={BaseDamage}, ArmoPierLevel={ArmorPierceLevel}, Knockback={Knockback}, PenetrationLevel={PenetrationCount}, Decay={PenetrationDamageDecayPercent}%, PartOverrides={(partOverrides != null ? partOverrides.Length : 0)}",
                this
            );
        }
    }
